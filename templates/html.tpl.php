...
<head>
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="<?php path_to_theme(); ?>/images/apple-touch-icon.png">
  <link rel="icon" type="image/png" sizes="32x32" href="<?php path_to_theme(); ?>/images/favicon-32x32.png">
  <link rel="icon" type="image/png" sizes="16x16" href="<?php path_to_theme(); ?>/images/favicon-16x16.png">
  <link rel="manifest" href="<?php path_to_theme(); ?>/images/site.webmanifest">
